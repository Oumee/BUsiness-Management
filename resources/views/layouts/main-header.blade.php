								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											{{-- <span class="badge badge-pill badge-warning mr-auto my-auto float-left">Marquer tout comme lu</span> --}}
										</div>
										<div id="unreadcount">
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">Vous avez {{ auth()->user()->unreadNotifications->count() }} notifications non lus</p>
										</div>
									</div>
									...
									<div class="main-notification-list Notification-scroll">
										...
										<a class="d-flex p-3 border-bottom" href="{{ $notification->data['action'] }}">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{ $notification->data['title'] }} par
									...
									<div class="dropdown-footer">
										<a href="/vue_all">Marquer comme vue</a>
									</div>
								</div>
							</div>
