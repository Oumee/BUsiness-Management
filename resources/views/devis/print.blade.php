...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Les devis</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                     Téléchargement de devis  </span>
            </div>
        </div>
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <button class="btn btn-danger  float-left mt-3 mr-2" id="print_Button" onclick="printDiv()"> 
                            <i    class="mdi mdi-printer ml-1"></i>Imprimer</button>
                    </div>
                </div>
            </div>
        </div><!-- COL-END -->
